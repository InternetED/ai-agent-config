...
- **Use when:** creating or editing skills, or modifying `AGENTS.md` / `CLAUDE.md` (or other agent-consumed docs).
- **Not for:** implementing product features, or routing which skill to run (use `ask-matt`).
